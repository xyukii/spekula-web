...
class Feedzy_Rss_Get_Item {
	 ...
	 * Get author.
	 *
	 * @return Feedzy_Rss_Item_Enclosures Item author.
	 */
	 ...
	 * Get item description.
	 *
	 * @return Feedzy_Rss_Feeds_Pro_Amazon_Product_Advertising item object.
	 */
	 ...
	 * Get enclosures info.
	 *
	 * @return array<Feedzy_Rss_Item_Enclosures>
	 */
	 ...
	 * Get item tags.
	 *
	 * @param string $item_namespace Item namespace.
	 * @param string $tag Custom TagName.
	 * @return array<string, string>
	 */
	public function get_item_tags( $item_namespace, $tag ) {
		if ( 'price' === $tag ) {
			return array(
				array(
